...
### 特性（无后台版本）：
- **一**. 完整的[ChatGPT-Next-Web](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web)功能，并保持同步更新。最近同步时间：2024.10.18
...
7.如果是用宝塔或者1panel部署的，很有可能会出现更新版本后，看镜像已经是新版了，但域名访问进去看到的还是旧的版本，这是宝塔或者1panel的问题，这时候需要换个映射端口。
