...
- 版本号：
  - 3.7.20，完整功能，需要授权码
  - 3.7.20-arm，arm64版，完整功能，需要授权码
  - 3.7.20-ce，社区版(免费版)，不需要授权码，功能有限制，详细看后面说明
- 演示地址：
...
### 特性（无后台版本）：
- **一**. 完整的[ChatGPT-Next-Web](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web)功能，并保持同步更新。最近同步时间：2024.05.09
...
##### 1.拉取镜像
```shell
docker pull registry.cn-hangzhou.aliyuncs.com/ann-chat/chatgpt-next-web-pro:3.7.20
```
##### 2.启动应用
```shell
docker run -d -p 3000:3000 \
  ...
  registry.cn-hangzhou.aliyuncs.com/ann-chat/chatgpt-next-web-pro:3.7.20
```
